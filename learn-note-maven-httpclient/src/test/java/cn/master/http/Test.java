...
import my.master.http.HttpCilentsTest;
import my.master.http.HttpClientUtils;
...
//		test4();
		...
		header.put("Accept-Encoding", "*;q=0");
		header.put("Accept-Language", "zh-CN,zh;q=0.9,en;q=0.8");
		header.put("Cookie", "pgv_info=ssid=s3116961539; pgv_pvid=6629919576");
		header.put("Cache-Control", "max-age=0");
		header.put("Connection", "keep-alive");
		header.put("Host", "pingfore.qq.com");
		header.put("Referer", "https://ac.qq.com/ComicView/index/id/621058/cid/2");
		header.put("Upgrade-Insecure-Requests", "1");
		header.put("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36");
		String url = "https://pingfore.qq.com/pingd?dm=ac.qq.com&url=/ComicView/index/id/621058/cid/2&rdm=ac.qq.com&rurl=/Comic/comicInfo/id/621058&rarg=-&pvid=6629919576&scr=1920x1080&scl=24-bit&lang=zh-cn&java=0&pf=Win32&tz=-8&flash=-&ct=-&vs=tcss.3.1.5&ext=tm%3D3&hurlcn=&rand=35320&reserved1=-1&tt=";
		
//		Map param = new HashMap();
//		param.put("dm", "ac.qq.com");
//		param.put("url", "/ComicView/index/id/621058/cid/2");
//		dm: 
//		url: 
//		rdm: ac.qq.com
//		rurl: /Comic/comicInfo/id/621058
//		rarg: -
//		pvid: 6629919576
//		scr: 1920x1080
//		scl: 24-bit
...
//		tt:
		...
		String doPost = HttpClientUtils.doGet(url ,null,header, 5000, 1000,5000);
